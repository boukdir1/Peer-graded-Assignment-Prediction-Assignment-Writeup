...
With the help of devices such as Jawbone Up, the Nike FuelBand and Fitbit, it is now possible to collect a large amount of personal activity data at a relatively low cost. These kinds of devices are part of the quantified self-movement ? the group of enthusiasts who regularly take action on themselves to improve their health, to find role models in their behavior, or because they are technology geeks. One thing that people regularly do is to quantify the quantity of a particular activity they do, but they rarely quantify the quantity of the quality of that activity. In this project, your goal will be to use data from the accelerometers on the belt, forearm, arm and dumbbell of 6 participants. The participants have been asked to perform bar lifts correctly and incorrectly in 5 different ways. More details are available on the following website: http://groupware.les.inf.puc-rio.br/har (see the section on the weightlifting exercise data set).
